...
static __attribute__ ((used)) void* __ptr_sceAvPlayerGetVideoData;
asm(".intel_syntax noprefix\n"
...
__constructor(void) {
  if(sprx_dlopen("libSceAvPlayer", &__handle)) return;
  ...
  if(sprx_dlsym(__handle, "o3+RWnHViSg", &__ptr_sceAvPlayerGetVideoData)) return;
